...
func (c *brokerClient) IncIdx(ctx context.Context, in *IncIdxRequest, opts ...grpc.CallOption) (*IncIdxResponse, error) {
	out := new(IncIdxResponse)
	err := c.cc.Invoke(ctx, "/broker.Broker/IncIdx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Broker_IncIdx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IncIdxRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BrokerServer).IncIdx(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/broker.Broker/IncIdx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BrokerServer).IncIdx(ctx, req.(*IncIdxRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Broker_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IncIdx",
			Handler:    _Broker_IncIdx_Handler,
		},
	},
