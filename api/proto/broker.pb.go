...
var file_broker_proto_goTypes = []interface{}{
	(*PublishRequest)(nil),   // 0: app.PublishRequest
	(*PublishResponse)(nil),  // 1: app.PublishResponse
	(*SubscribeRequest)(nil), // 2: app.SubscribeRequest
	(*MessageResponse)(nil),  // 3: app.MessageResponse
	(*FetchRequest)(nil),     // 4: app.FetchRequest
}
var file_broker_proto_depIdxs = []int32{
	0, // 0: app.Broker.Publish:input_type -> app.PublishRequest
	2, // 1: app.Broker.Subscribe:input_type -> app.SubscribeRequest
	4, // 2: app.Broker.Fetch:input_type -> app.FetchRequest
	1, // 3: app.Broker.Publish:output_type -> app.PublishResponse
	3, // 4: app.Broker.Subscribe:output_type -> app.MessageResponse
	3, // 5: app.Broker.Fetch:output_type -> app.MessageResponse
